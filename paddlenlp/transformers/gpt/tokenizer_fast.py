...
class GPTTokenizerFast(PretrainedTokenizerFast):
    """
    Construct a "fast" GPT tokenizer (backed by PaddleNLP's *tokenizers* library). Based on byte-level
    Byte-Pair-Encoding.
    ...
    ```python
    >>> from paddlenlp.transformers.gpt import GPTTokenizerFast

    >>> tokenizer = GPTTokenizerFast.from_pretrained("openai-community/gpt2")
